...
<body>
  ...
  <div class="container">
    <form action="selectcar" method="post">
		Plate Number <input type="text" name="platenumber" placeholder = "Enter Plate Number"><br>
	...
	<label for="agree">Add New Vehicle?</label><br><br>
	<a href="carinsert.jsp" class="signup">Click to add</a>
  </div>
