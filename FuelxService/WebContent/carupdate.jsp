...
<body>
  ...
  <hr style="color:white;">
	...
	<table>
		...
		<tr>
		<td>Plate Number </td>
		<td><input type ="text" name="platenumber" value="<%=platenumber%> "required></td>
		</tr>
		<tr>
		<td>Model</td>
		...
		<tr>
		<td>Year</td>
		<td> <input type ="text" name ="year" value="<%=year%> " maxlength="4" required></td>
		</tr>
		<tr>
		<td>Color</td>
		...
		<tr>
		<td>Fuel Type</td>
		<td> <input type="text" name="fueltype" value="<%=fueltype%> "required></td>
		</tr>
		
		</table>
		<br>
		<input type="submit" name ="submit" value="Update Car"> <br>
