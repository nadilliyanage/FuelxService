...
<body>
  ...
  <nav>
	...
	<div class="container">
	<form action="chooseAppointment" method="post">
	<h2>Choose Appointment</h2>
		<label>Vehicle Number</label><br>
		 <input class="field" type="text" name="vehicleNumber" placeholder="Enter your vehicle number"><br>
		<label>Model</label><br>
		 <input class="field" type="text" name="model" placeholder="Enter your vehicle model"><br><br>
		 
		<input type="submit" name="submit" value="Find Appointment">
	</form>
	</div>
